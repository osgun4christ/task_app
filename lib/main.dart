...
class _TaskListScreenState extends State<TaskListScreen> {
  ...
  List<Task> _taskList = [];
  String _userName = "User"; // Static for simplicity, you can make this dynamic
  String _currentDate = "";
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    if (picked != null) {
                      ...
                      if (timePicked != null) {
                        setState(() {
                          task?.deadline = DateTime(picked.year, picked.month, picked.day, timePicked.hour, timePicked.minute);
                        });
                      }
                    }
                  },
  ...
  void _markAsCompleted(Task task) {
    final updatedTask = Task(id: task.id, title: task.title, deadline: task.deadline, isCompleted: !task.isCompleted);
    _dbHelper.updateTask(updatedTask).then((_) {
      _updateTaskList();
    });
  }
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Card(
                  color: task.isCompleted ? const Color.fromARGB(255, 95, 218, 177) : null,
